...
<table width="100%" class="ap-table">
  <tr>
    ...
    <div class="ap-tabs-content">
        ...
        Click <a href="admin.php?page=login_log_ap">here</a> to check the user <strong>Login Log</strong>. Use <strong><a href="https://goplugins.in/fb-login-widget-pro/" target="_blank">PRO</a></strong> version that has added security with <strong>Blocking IP</strong> after 5 wrong login attempts. <strong>Blocked IPs</strong> can be <strong>Whitelisted</strong> from admin panel or the <strong>Block</strong> gets automatically removed after <strong>1 Day</strong>.
        </div>
        </td>
        </tr>
        <tr>
